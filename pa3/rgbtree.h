...
public:
  ...
  /* nearest neighbor function.                                     */
    ...
    */
    void rgbtreeHelper(int start, int end, int d);


    /* helper function for findNN
    */
    RGBAPixel findNNhelper(const RGBAPixel& query, int start, int end, int dim, RGBAPixel& bestPixel) const;

    int distToPoint(const RGBAPixel& first, const RGBAPixel& second) const;
